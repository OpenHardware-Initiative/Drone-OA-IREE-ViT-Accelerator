...
from models.testing.ITA_layers_export import ITASelfAttention_Export, ITAFeedForward_Export
...
class ITALSTMNetVIT_Export(nn.Module):
    ...
    def __init__(self):
        ...
        # --- 2. ITA Accelerated Part (using EXPORT versions of layers) ---
    ...
    def forward_with_intermediates(self, X):
        ...
        tensors from the converted and refactored PyTorch model.
        """
        X = refine_inputs(X)
