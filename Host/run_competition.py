...
import os
import sys
# This adds your main project folder ('DRONE_OA_IREE') to the path
...
from Host.user_code import compute_command_vision_based, compute_command_state_based 
from Host.utils import AgileCommandMode, AgileQuadState
