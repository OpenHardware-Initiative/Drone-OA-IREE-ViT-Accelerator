...
module attributes {transform.with_named_sequence} {
  ...
  hal.executable private @custom_ita_executable {
    ...
    objects([#hal.executable.object<{path = "dummy_dispatch_aarch64.o"}>]) {
  ...
  util.func private @call_ITASelfAttention(%in_arg: tensor<1x128x128xf32>) -> tensor<1x128x128xf32> {
    ...
    %result = flow.dispatch @custom_ita_executable::@aarch64::@ITASelfAttention[%workload](
      %in_arg
